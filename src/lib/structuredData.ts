...
/**
 * JSON-LD sicher in ein <script>-Tag einbetten. JSON.stringify lässt "<"
 * unverändert — ein Event-Titel mit "</script>" würde das Skript-Tag
 * beenden und danach beliebiges HTML/JS einschleusen. Die Zeichen werden
 * als Unicode-Escapes geschrieben, was in JSON gleichwertig bleibt.
 */
